...
The `example/` directory demonstrates the expected project structure for DevBox:
...
### Features System
Features are modular components that can be added to DevBox containers and are just modified features from devcontainer project:
